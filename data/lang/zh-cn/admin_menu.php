<?php
return array (
  'ADMIN_CHOICENAME_ADDPOST' => '添加竞猜名称保存',
  'ADMIN_CHOICENAME_DELETE' => '删除竞猜名称',
  'ADMIN_CHOICENAME_EDITPOST' => '编辑竞猜名称保存',
  'ADMIN_CHOICENAME_INDEX' => '竞猜名称',
  'ADMIN_CHOICENAME_SORT' => '排序',
  'ADMIN_CHOICENAME_UPDATE' => '停用启用竞猜名称',
  'ADMIN_CLASSIFY_ADDPOST' => '添加赛事保存',
  'ADMIN_CLASSIFY_DEFAULT' => '各种分类',
  'ADMIN_CLASSIFY_DELETE' => '删除赛事',
  'ADMIN_CLASSIFY_EDITPOST' => '编辑赛事保存',
  'ADMIN_CLASSIFY_INDEX' => '赛事分类',
  'ADMIN_CLASSIFY_SORT' => '排序',
  'ADMIN_CLASSIFY_UPDATE' => '停用启用赛事',
  'ADMIN_CURRENCY_ADD' => '添加虚拟币',
  'ADMIN_CURRENCY_ADDPOST' => '添加虚拟币保存',
  'ADMIN_CURRENCY_DEFAULT' => '虚拟币',
  'ADMIN_CURRENCY_DELETE' => '删除虚拟币',
  'ADMIN_CURRENCY_EDIT' => '编辑虚拟币',
  'ADMIN_CURRENCY_EDITPOST' => '编辑虚拟币提交保存',
  'ADMIN_CURRENCY_INDEX' => '币值列表',
  'ADMIN_CURRENCY_UPDATE' => '停用启用虚拟币',
  'ADMIN_GOODS_ADD' => '添加商品',
  'ADMIN_GOODS_ADDPOST' => '添加商品保存',
  'ADMIN_GOODS_DEFAULT' => '商品',
  'ADMIN_GOODS_DELETE' => '删除商品',
  'ADMIN_GOODS_EDIT' => '编辑商品',
  'ADMIN_GOODS_EDITPOST' => '编辑商品提交保存',
  'ADMIN_GOODS_INDEX' => '商品列表',
  'ADMIN_GOODS_UPDATE' => '停用启用商品',
  ...
  'ADMIN_MATCH_ADD' => '添加战队',
  'ADMIN_MATCH_ADDPOST' => '添加战队保存',
  'ADMIN_MATCH_DEFAULT' => '比赛',
  'ADMIN_MATCH_DELETE' => '删除战队',
  'ADMIN_MATCH_EDIT' => '编辑商品',
  'ADMIN_MATCH_EDITPOST' => '编辑战队保存',
  'ADMIN_MATCH_INDEX' => '赛事管理',
  'ADMIN_MATCH_UPDATE' => '停用启用战队',
  'ADMIN_MATCHBUREAU_ADDPOST' => '添加局名称保存',
  'ADMIN_MATCHBUREAU_DELETE' => '删除局名称',
  'ADMIN_MATCHBUREAU_EDITPOST' => '编辑局名称保存',
  'ADMIN_MATCHBUREAU_INDEX' => '局名称',
  'ADMIN_MATCHBUREAU_UPDATE' => '停用启用局名称',
  'ADMIN_MATCHCHOICE_ADD' => '添加竞猜',
  'ADMIN_MATCHCHOICE_ADDPOST' => '添加竞猜保存',
  'ADMIN_MATCHCHOICE_DELETE' => '删除竞猜',
  'ADMIN_MATCHCHOICE_EDIT' => '编辑竞猜',
  'ADMIN_MATCHCHOICE_EDITPOST' => '编辑竞猜保存',
  'ADMIN_MATCHCHOICE_INDEX' => '竞猜列表',
  'ADMIN_MATCHCHOICE_UPDATE' => '停用启用竞猜',
  'ADMIN_MATCHDISC_ADDPOST' => '添加盘分类保存',
  'ADMIN_MATCHDISC_DELETE' => '删除盘分类',
  'ADMIN_MATCHDISC_EDITPOST' => '编辑盘分类保存',
  'ADMIN_MATCHDISC_INDEX' => '盘分类',
  'ADMIN_MATCHDISC_UPDATE' => '停用启用盘分类',
  ...
  'ADMIN_WARTEAM_ADD' => '添加战队',
  'ADMIN_WARTEAM_ADDPOST' => '添加战队保存',
  'ADMIN_WARTEAM_DELETE' => '删除战队',
  'ADMIN_WARTEAM_EDIT' => '编辑商品',
  'ADMIN_WARTEAM_EDITPOST' => '编辑战队保存',
  'ADMIN_WARTEAM_INDEX' => '战队列表',
  'ADMIN_WARTEAM_UPDATE' => '停用启用战队',
