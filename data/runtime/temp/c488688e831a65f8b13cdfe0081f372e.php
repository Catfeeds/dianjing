<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"themes/admin_simpleboot3/admin\currency\index.html";i:1534992925;s:75:"E:\xampp\htdocs\dianjing\public\themes\admin_simpleboot3\public\header.html";i:1534389699;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <tbody>
                <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td><img src="<?php echo $vo['icon']; ?>" alt=""></td>
                            <td>100:<?php echo $vo['ratio']; ?></td>
                            <td>
                                <?php switch($vo['ratio_name']): case "": ?>
                                        人民币
                                    <?php break; default: ?>
                                    <?php echo $vo['ratio_name']; endswitch; ?>
                            </td>
                            ...
                            <td>
                                <?php switch($vo['status']): case "1": ?>
                                        <a class="js-ajax-dialog-btn"
                                           ...
                                           href="<?php echo url('Currency/update',array('id'=>$vo['id'],'status'=>2)); ?>"><?php echo lang('DISABLED'); ?></a>
                                    <?php break; case "2": ?>
                                        <a class="js-ajax-dialog-btn"
                                           data-msg="你确定要<?php echo lang('ENABLED'); ?>"
                                           href="<?php echo url('Currency/update',array('id'=>$vo['id'],'status'=>1)); ?>"><?php echo lang('ENABLED'); ?></a>
                                    <?php break; default: ?>
                                    未知状态
                                <?php endswitch; ?>
                                <a href="<?php echo url('Currency/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                                <a href="<?php echo url('Currency/delete',array('id'=>$vo['id'])); ?>" class="js-ajax-delete">
