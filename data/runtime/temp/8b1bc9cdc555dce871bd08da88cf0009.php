...
<div id="body" v-cloak>
    ...
    <div class="select" style="background: #ebebeb;margin-bottom: 0">
        ...
        <img src="<?php echo $data['icon']; ?>"  ><span><?php echo empty($user['diamond']['number'])?'0.00':$user['diamond']['number']; ?></span>
    ...
    <div class="pay" style=" width: 100%;position: fixed;bottom: 0">
        <button type="submit" style="background: #e0e000;text-align: center;line-height: 55px;height: 55px;width: 100%;color: #333;font-size: 16px">支付</button>
    </div>
