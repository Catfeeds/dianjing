<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"themes/admin_simpleboot3/admin\war_team\index.html";i:1534744278;s:75:"E:\xampp\htdocs\dianjing\public\themes\admin_simpleboot3\public\header.html";i:1534389699;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo url('WarTeam/add'); ?>">添加战队</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('WarTeam/index'); ?>">
        名称:
        ...
        <a class="btn btn-danger" href="<?php echo url('WarTeam/index'); ?>">清空</a>
    </form>
                            ...
                            <td>
                                <?php switch($vo['status']): case "1": ?>
                                        <a class="js-ajax-dialog-btn"
                                           ...
                                           href="<?php echo url('WarTeam/update',array('id'=>$vo['id'],'status'=>2)); ?>"><?php echo lang('DISABLED'); ?></a>
                                    <?php break; case "2": ?>
                                        <a class="js-ajax-dialog-btn"
                                           data-msg="你确定要<?php echo lang('ENABLED'); ?>"
                                           href="<?php echo url('WarTeam/update',array('id'=>$vo['id'],'status'=>1)); ?>"><?php echo lang('ENABLED'); ?></a>
                                    <?php break; default: ?>
                                    未知状态
                                <?php endswitch; ?>
                                <a href="<?php echo url('WarTeam/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                                <a href="<?php echo url('WarTeam/delete',array('id'=>$vo['id'])); ?>" class="js-ajax-delete">
