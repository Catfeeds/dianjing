<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"themes/admin_simpleboot3/admin\currency\add.html";i:1534412320;s:75:"E:\xampp\htdocs\dianjing\public\themes\admin_simpleboot3\public\header.html";i:1534389699;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a>添加虚拟币</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Currency/addPost'); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-ratio" name="ratio" placeholder="请按百分比计算，例如：20 则是 20%" required>
				</div>
			</div>
			<div class="form-group">
