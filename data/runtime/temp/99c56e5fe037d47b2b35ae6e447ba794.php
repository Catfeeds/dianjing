<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/admin_simpleboot3/admin\goods\add.html";i:1534415815;s:75:"E:\xampp\htdocs\dianjing\public\themes\admin_simpleboot3\public\header.html";i:1534389699;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Goods/addPost'); ?>">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="hidden" class="form-control" id="thumbnail" name="img" required>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="number" class="form-control" id="input-ratio" name="price"  required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="number" class="form-control" id="input-stock" name="stock" value="0"  required>
				</div>
			</div>
			<div class="form-group">
